...
import { faFolder, faFileSignature, faBriefcase, faUsers, faHome, faUserGraduate } from '@fortawesome/free-solid-svg-icons'; // Ajout de faUserGraduate
        ...
        <div style={styles.sidebar}>
            <ul style={styles.menu}>
                <li style={styles.menuItem}>
                    <Link to="/" style={styles.menuLink}> {/* Lien vers la page d'accueil */}
                        <FontAwesomeIcon icon={faHome} style={styles.icon} /> {/* Icône Home */}
                        Home
                    </Link>
                </li>
                <li style={styles.menuItem}>
                ...
                <li style={styles.menuItem}> {/* Nouvelle section pour Stagiaire */}
                    <Link to="/stagiaire" style={styles.menuLink}>
                        <FontAwesomeIcon icon={faUserGraduate} style={styles.icon} /> {/* Icône Stagiaire */}
                        Stagiaire
                    </Link>
                </li>
            </ul>
